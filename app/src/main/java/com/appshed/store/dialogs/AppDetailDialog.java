package com.appshed.store.dialogs;
...
import com.appshed.store.services.DeleteAppService;
import com.appshed.store.services.RetrieveAppService;
import com.appshed.store.services.UpdateAppService;
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.img_share:
				...
				sendIntent.putExtra(Intent.EXTRA_SUBJECT, selectedApp.getName());
				sendIntent.putExtra(Intent.EXTRA_TITLE, selectedApp.getName());
